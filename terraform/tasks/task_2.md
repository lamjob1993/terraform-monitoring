...
### Разворачивание пустых контейнеров
...
- Нужно написать Terraform IaC темплейт для раворачивания x10 пустых контейнеров Docker с ОС Debian + x10 пустых контейнеров Podman с ОС CentOS.
...
- Пока что учимся разворачивать пустые контейнеры в вакууме, но в следующем репозитории Ansible мы накатим на контейнеры (VM-ки) инфру мониторинга и постепенно будем наращивать сложность.
