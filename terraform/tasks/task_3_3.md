...
_Для этого задания возьмите 5 листов формата A4 и распишите код каждого файла. Далее разлодите листки бумаги на столе и нарисуйте фломастером логику взаимодействия переменных в каждом файле (далее можно сделать фотку на телефон). Делайте упражнение до тех пор, пока не запомните механику. С Ansible будет также, но уже сильно проще._
