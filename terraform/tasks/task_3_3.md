...
_Для этого задания возьмите 5 листов формата A4 и распишите код каждого файла. Далее разлодите листки бумаги на столе и нарисуйте фломастером логику взаимодействия переменных в каждом файле (далее можно сделать фотку на телефон). Делайте это упражнение до тех пор, пока не запомните механику. Делайте упражнение с A4, как минимум 3 дня. С Ansible будет также, но уже сильно проще._
