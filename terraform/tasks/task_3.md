...
ВНИМАНИЕ!!! Деплоем инфры занимается Terraform, а деплоем конфигов и запуском ПО занимается Ansible, но в данном задании Terraform выполняет роль и одного и второго инструмента. Это сделано для более полного спектра инструментария Terraform (модули, циклы и т.д).
