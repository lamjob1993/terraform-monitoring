...
#### 4. Способ с альтернативными зеркалами. В файл `.tofurc` вписываем следующий конфиг (для загрузки провайдеров [с вашего зеркала](https://terraform-registry-mirror.ru/) - способ быстрый и работает на территории РФ):
...
#### 5. Ручная загрузка провайдеров (так как скорее всего зеркала будут недоступны)
